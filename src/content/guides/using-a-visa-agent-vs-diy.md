...
tags: ["visa agent", "diy visa", "scams", "retirement extension"]
verifyPending: false
sources:
...
faq:
  ...
  - q: "How much does a visa agent cost?"
    a: "Fees vary by service and complexity, from modest help with paperwork to full handling. Get a clear written quote, and be wary of prices that only make sense if rules are being circumvented."
related: ["retirement-extension-step-by-step", "thailand-retirement-visa-options"]
---
...
These are the patterns we cover in [Safety & Scams](/safety-scams/). A legitimate agent helps you meet the rules; no one can lawfully make the rules not apply to you.
