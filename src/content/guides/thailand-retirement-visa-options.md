---
title: "Thailand Retirement Visa Options, Explained Honestly"
description: "The real retirement visa routes for Pattaya — annual extension, O-A, O-X and LTR — what each costs, who it suits, and the trade-offs agents won't mention."
pillar: "visas"
...
takeaways:
  ...
  - "The LTR visa can mean far less yearly admin if your income is comfortable."
keyFacts:
...
<aside class="callout callout-warn">
  ...
  <div>
    <p class="callout-title">Plan the money timing first</p>
    <p>The single most common avoidable problem is the seasoning rule — funds arriving too late to count. Map your transfers against the current requirement <em>before</em> you book flights.</p>
  </div>
</aside>
