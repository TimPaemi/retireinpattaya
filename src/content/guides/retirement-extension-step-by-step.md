...
steps:
  ...
  - name: "Meet the financial requirement"
    text: "Qualify via a seasoned lump-sum deposit, a monthly income, or a combination — verify current amounts."
  - name: "Gather your documents"
    text: "Passport, bank book and letter, application form and photos, proof of address and TM30, plus insurance if required."
  - name: "Apply at your local office"
    text: "Submit at Jomtien Immigration for most of Pattaya; go early to beat the queues."
  - name: "Stay compliant all year"
    text: "Keep up 90-day reporting and TM30, and get a re-entry permit before any travel."
keyFacts:
  - label: "Where (Pattaya)"
    value: "Jomtien Immigration"
  - label: "Renewal"
    value: "Annual"
