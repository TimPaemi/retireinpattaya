...
export const DESTINATIONS: Destination[] = [
  ...
  { name: 'Koh Samui (Thailand)', group: 'Thailand', afford: 3, healthcare: 3, visa: 4, warmth: 5, english: 4, community: 3, safety: 4, proximity: 2, downside: 'Island logistics; complex care may mean a flight to the mainland.' },
